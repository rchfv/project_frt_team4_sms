...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $notmsg=$_POST['notmsg'];
 $eid=$_GET['editid'];
$sql="update tblnotice set NoticeTitle=:nottitle,ClassId=:classid, NoticeMsg=:notmsg where ClassId=:eid";
...
<html lang="en">
  <head>
    ...
    <title>Magic Bus Student Management System|| Update Notice</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      <?php
$eid=$_GET['editid'];
$sql="SELECT tblclass.ID,tblclass.ClassName,tblclass.Section,tblnotice.NoticeTitle,tblnotice.CreationDate,tblnotice.ClassId,tblnotice.NoticeMsg,tblnotice.ID as nid from tblnotice join tblclass on tblclass.ID=tblnotice.ClassId where tblnotice.ClassId=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();
